#------------------------------------------------------------------------------
# 02 - ConstructATACseqCountMatrix.R
#------------------------------------------------------------------------------
...
#--------- analysis ---------#
system("mkdir output/inserts_bed output/sample_peaks_row/")
...
names(reproduciblePeaks) <- paste0("JFCRPeaks_", c(1:length(reproduciblePeaks)))
